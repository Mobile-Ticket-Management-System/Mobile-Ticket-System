...
<?php
        ...
        $check_email = $conn->prepare("SELECT * FROM customers WHERE email = ? OR phone = ?");
...
<?php
            ...
            $stmt = $conn->prepare("INSERT INTO customers (name, email, password, phone, address, loc) VALUES (?,?,?,?,?,?)");
